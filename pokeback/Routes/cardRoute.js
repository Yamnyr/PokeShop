...
const {updateCard, deleteCard, getCards, getCard, getCardByUser, createCard, getMyCards} = require("../Controllers/cardController");
...
router.get("/getmycards", authMiddleware, getMyCards);
